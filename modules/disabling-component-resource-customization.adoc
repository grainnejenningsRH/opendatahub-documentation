...
ifndef::upstream[]
To remove the annotation from a deployment, use the steps described in link:{rhoaidocshome}{default-format-url}/customizing-component-resources/reenabling-component-resource-customization_resource-mgmt[Re-enabling component resource customization].
endif::[]
====
...
[NOTE]
====
For more information about the deployment names for each component, see link:{rhoaidocshome}{default-format-url}/customizing-component-resources/overview-of-component-resource-customization_resource-mgmt[Overview of component resource customization].
====
endif::[]
