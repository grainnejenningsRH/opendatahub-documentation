...
To configure the model registry feature, you must install the following Operators in {openshift-platform}, and then enable the `modelregistry` component in {productname-short}.
endif::[]
