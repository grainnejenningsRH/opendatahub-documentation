...
Distributed workloads are submitted to this queue if no `local_queue` value is specified in the `ClusterConfiguration` section of the data science pipeline, Jupyter or code-server notebook, or Microsoft Visual Studio Code file.
